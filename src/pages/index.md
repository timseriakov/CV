...
Ведущий React / React Native разработчик с 8+ лет опыта: проектировал B2B/B2C-системы, CRM, внутренние инструменты и full-stack решения. Выстраиваю Software Development Lifecycle вокруг спецификаций, архитектурных решений и проверяемых сценариев, где документация выступает Single Source of Truth по отношению к коду и процессам.

## Ключевые навыки

* Техническая стратегия и архитектура
* Software Development Lifecycle и инженерные процессы
* Спецификации, архитектурные решения и проверяемые сценарии
* Декомпозиция и ADR
* AI-assisted development и инженерная автоматизация
* Domain‑Driven Design (DDD)
* Микросервисы и модульные монолиты
* CI/CD: проектирование и внедрение
* Подбор и наставничество специалистов
* TypeScript и Node.js (NestJS/Hono)
* React / React Native
...
* Разбирался в legacy-коде, зависимостях и пользовательских сценариях при неполной документации и передаче контекста.
* Работал по макетам, устным требованиям и частично описанным задачам; самостоятельно уточнял поведение, доводил реализацию до проверки сценариев.
* Использовал AI для быстрого разбора чужого кода и библиотек, проверки гипотез и выбора реализации.
